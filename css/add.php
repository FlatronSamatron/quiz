...
<?php 
	if(isset($_POST['submit'])){
		...
		//Воросы
		$query_row = mysqli_query($con,"INSERT INTO questions_css (question_number, text)
		...
		if($query_row){
			foreach($choices as $choice => $value){
				if($value != ''){
					...
					//Варианты ответа
					$query = mysqli_query($con,"INSERT INTO choices_css (question_number, is_correct, text)
