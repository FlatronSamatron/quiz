...
<?php 
	...
	$scores = $_SESSION['score_html'];
	$total = $_SESSION['total_html'];
	$user = $_SESSION['user'];
	...
	$correct_choice = $row['score_html'];
	/*Если количество правильных ответов больше предыдущего записываем*/
	if($scores>$correct_choice){
	$score = mysqli_query($con,"UPDATE users SET score_html = '$scores' WHERE username = '$user' ");
	}
?>
<!DOCTYPE html>
<html>
